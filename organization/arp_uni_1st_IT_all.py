...
from surf_dst.globals import unpickle_obj, clean_dir
from surf_dst.surf.model import ModelCSRV, gen_tlist
from surf_dst.spatial.sparse import compute_cdf, compute_hist, compute_J
...
ROOT_PATH = '/path/to/arp23/complex/project'

# Input STAR file
in_star = ROOT_PATH + '/ltomos_all/IT_all_mask/IT_all_mask_ltomos.star' 
in_wspace = None # (Insert a path to recover a pickled workspace instead of doing a new computation)

# Output directory
out_dir = ROOT_PATH + '/uni_sph_1st_all_IT'
out_stem = 'IT_all_sim20' 
